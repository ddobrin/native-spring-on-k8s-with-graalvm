...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(org.springframework.boot.test.autoconfigure.web.servlet.AutoConfigureMockMvc.class, () -> new org.springframework.cloud.function.context.config.ContextFunctionCatalogAutoConfiguration());
